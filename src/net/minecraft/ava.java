...
public abstract class ava extends avb {
	...
	protected boolean l(BlockState var1) {
		return this.M;
	}
	...
	protected void g(World var1, Position var2, BlockState var3) {
		if (!this.b((ard) var1, var2, var3)) {
	...
	protected int f(World var1, Position var2, BlockState var3) {
	...
	protected int c(ard var1, Position var2, BlockState var3) {
		BlockFace var4 = (BlockFace) var3.b(N);
	...
	protected void h(World var1, Position var2, BlockState var3) {
		BlockFace var4 = (BlockFace) var3.b(N);
	...
	protected int a(ard var1, Position var2, BlockState var3) {
		return 15;
	}
	...
	public boolean i(World var1, Position var2, BlockState var3) {
	...
	protected int m(BlockState var1) {
		return this.d(var1);
	}

	protected abstract int d(BlockState var1);

	protected abstract BlockState e(BlockState var1);

	protected abstract BlockState k(BlockState var1);
