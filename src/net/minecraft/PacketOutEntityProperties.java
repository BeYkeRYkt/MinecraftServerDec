...
public class PacketOutEntityProperties implements Packet<PlayClientboundPacketListener> {
	...
	public PacketOutEntityProperties(int entityId, Collection<AttributeInstance> attributes) {
