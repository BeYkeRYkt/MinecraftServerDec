...
public class aou {
	...
	public void a(aop var1) {
		...
		var1.a(new ItemStack(Blocks.SANDSTONE, 1, bae.b.a()), new Object[] { "#", "#", Character.valueOf('#'), new ItemStack(Blocks.STONE_SLAB, 1, bbg.b.a()) });
		var1.a(new ItemStack(Blocks.RED_SANDSTONE, 1, azr.b.a()), new Object[] { "#", "#", Character.valueOf('#'), new ItemStack(Blocks.STONE_SLAB2, 1, aym.a.a()) });
		var1.a(new ItemStack(Blocks.QUARTZ_BLOCK, 1, azn.b.a()), new Object[] { "#", "#", Character.valueOf('#'), new ItemStack(Blocks.STONE_SLAB, 1, bbg.h.a()) });
		...
		var1.a(new ItemStack(Blocks.STONEBRICK, 4), new Object[] { "##", "##", Character.valueOf('#'), new ItemStack(Blocks.STONE, 1, bbb.a.a()) });
		var1.a(new ItemStack(Blocks.STONEBRICK, 1, BlockSmoothBrick.O), new Object[] { "#", "#", Character.valueOf('#'), new ItemStack(Blocks.STONE_SLAB, 1, bbg.f.a()) });
		var1.b(new ItemStack(Blocks.STONEBRICK, 1, BlockSmoothBrick.M), new Object[] { Blocks.STONEBRICK, Blocks.VINE });
		...
		var1.a(new ItemStack(Blocks.STONE, 2, bbb.d.a()), new Object[] { "CQ", "QC", Character.valueOf('C'), Blocks.COBBLESTONE, Character.valueOf('Q'), Items.QUARTZ });
		var1.b(new ItemStack(Blocks.STONE, 1, bbb.b.a()), new Object[] { new ItemStack(Blocks.STONE, 1, bbb.d.a()), Items.QUARTZ });
		...
		var1.a(new ItemStack(Blocks.PRISMARINE, 1, BlockPrismarine.M), new Object[] { "SSS", "SSS", "SSS", Character.valueOf('S'), Items.PRISMARINE_SHARD });
		var1.a(new ItemStack(Blocks.PRISMARINE, 1, BlockPrismarine.N), new Object[] { "SSS", "SIS", "SSS", Character.valueOf('S'), Items.PRISMARINE_SHARD, Character.valueOf('I'), new ItemStack(Items.DYE, 1, akv.p.b()) });
