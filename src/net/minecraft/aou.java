...
public class aou {
	...
	public void a(aop var1) {
		...
		var1.a(new ItemStack(Blocks.IRON_BARS, 16), new Object[] { "###", "###", Character.valueOf('#'), Items.j });
		var1.a(new ItemStack(Blocks.GLASS_PANE, 16), new Object[] { "###", "###", Character.valueOf('#'), Blocks.GLASS });
		var1.a(new ItemStack(Blocks.REDSTONE_LAMP, 1), new Object[] { " R ", "RGR", " R ", Character.valueOf('R'), Items.aC, Character.valueOf('G'), Blocks.GLOWSTONE });
