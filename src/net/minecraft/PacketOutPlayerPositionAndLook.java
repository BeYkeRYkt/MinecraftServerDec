...
public class PacketOutPlayerPositionAndLook implements Packet<PlayClientboundPacketListener> {
	...
	public PacketOutPlayerPositionAndLook() {
	}

	public PacketOutPlayerPositionAndLook(double x, double y, double z, float yaw, float pitch, Set<PositionFlag> flags) {
		this.x = x;
		this.y = y;
		this.z = z;
		this.yaw = yaw;
