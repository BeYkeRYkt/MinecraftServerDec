...
public class PacketPlayOutScoreboardObjective implements Packet<PlayOutPacketListener> {
	...
	public PacketPlayOutScoreboardObjective(ScoreboardObjective objective, int action) {
