...
public class aop {
	...
	private aop() {
		...
		this.a(new ItemStack(Blocks.FENCE, 3), new Object[] { "W#W", "W#W", Character.valueOf('#'), Items.y, Character.valueOf('W'), new ItemStack(Blocks.PLANKS, 1, ayx.a.a()) });
		this.a(new ItemStack(Blocks.BIRCH_FENCE, 3), new Object[] { "W#W", "W#W", Character.valueOf('#'), Items.y, Character.valueOf('W'), new ItemStack(Blocks.PLANKS, 1, ayx.c.a()) });
		this.a(new ItemStack(Blocks.SPRUCE_FENCE, 3), new Object[] { "W#W", "W#W", Character.valueOf('#'), Items.y, Character.valueOf('W'), new ItemStack(Blocks.PLANKS, 1, ayx.b.a()) });
		this.a(new ItemStack(Blocks.JUNGLE_FENCE, 3), new Object[] { "W#W", "W#W", Character.valueOf('#'), Items.y, Character.valueOf('W'), new ItemStack(Blocks.PLANKS, 1, ayx.d.a()) });
		this.a(new ItemStack(Blocks.ACACIA_FENCE, 3), new Object[] { "W#W", "W#W", Character.valueOf('#'), Items.y, Character.valueOf('W'), new ItemStack(Blocks.PLANKS, 1, 4 + ayx.e.a() - 4) });
		this.a(new ItemStack(Blocks.DARK_OAK_FENCE, 3), new Object[] { "W#W", "W#W", Character.valueOf('#'), Items.y, Character.valueOf('W'), new ItemStack(Blocks.PLANKS, 1, 4 + ayx.f.a() - 4) });
		...
		this.a(new ItemStack(Blocks.FENCE_GATE, 1), new Object[] { "#W#", "#W#", Character.valueOf('#'), Items.y, Character.valueOf('W'), new ItemStack(Blocks.PLANKS, 1, ayx.a.a()) });
		this.a(new ItemStack(Blocks.BIRCH_FENCE_GATE, 1), new Object[] { "#W#", "#W#", Character.valueOf('#'), Items.y, Character.valueOf('W'), new ItemStack(Blocks.PLANKS, 1, ayx.c.a()) });
		this.a(new ItemStack(Blocks.SPRUCE_FENCE_GATE, 1), new Object[] { "#W#", "#W#", Character.valueOf('#'), Items.y, Character.valueOf('W'), new ItemStack(Blocks.PLANKS, 1, ayx.b.a()) });
		this.a(new ItemStack(Blocks.JUNGLE_FENCE_GATE, 1), new Object[] { "#W#", "#W#", Character.valueOf('#'), Items.y, Character.valueOf('W'), new ItemStack(Blocks.PLANKS, 1, ayx.d.a()) });
		this.a(new ItemStack(Blocks.ACACIA_FENCE_GATE, 1), new Object[] { "#W#", "#W#", Character.valueOf('#'), Items.y, Character.valueOf('W'), new ItemStack(Blocks.PLANKS, 1, 4 + ayx.e.a() - 4) });
		this.a(new ItemStack(Blocks.DARK_OAK_FENCE_GATE, 1), new Object[] { "#W#", "#W#", Character.valueOf('#'), Items.y, Character.valueOf('W'), new ItemStack(Blocks.PLANKS, 1, 4 + ayx.f.a() - 4) });
		this.a(new ItemStack(Blocks.JUKEBOX, 1), new Object[] { "###", "#X#", "###", Character.valueOf('#'), Blocks.PLANKS, Character.valueOf('X'), Items.i });
		...
		this.a(new ItemStack(Blocks.SNOW, 1), new Object[] { "##", "##", Character.valueOf('#'), Items.aD });
		...
		this.a(new ItemStack(Blocks.IRON_TRAPDOOR, 1), new Object[] { "##", "##", Character.valueOf('#'), Items.j });
		...
		this.a(new ItemStack(Blocks.RAIL, 16), new Object[] { "X X", "X#X", "X X", Character.valueOf('X'), Items.j, Character.valueOf('#'), Items.y });
		...
		this.a(new ItemStack(Blocks.ACTIVATOR_RAIL, 6), new Object[] { "XSX", "X#X", "XSX", Character.valueOf('X'), Items.j, Character.valueOf('#'), Blocks.REDSTONE_TORCH, Character.valueOf('S'), Items.y });
		this.a(new ItemStack(Blocks.DETECTOR_RAIL, 6), new Object[] { "X X", "X#X", "XRX", Character.valueOf('X'), Items.j, Character.valueOf('R'), Items.aC, Character.valueOf('#'), Blocks.STONE_PRESSURE_PLATE });
		...
		this.a(new ItemStack(Blocks.TRIPWIRE_HOOK, 2), new Object[] { "I", "S", "#", Character.valueOf('#'), Blocks.PLANKS, Character.valueOf('S'), Items.y, Character.valueOf('I'), Items.j });
		this.a(new ItemStack(Blocks.REDSTONE_TORCH, 1), new Object[] { "X", "#", Character.valueOf('#'), Items.y, Character.valueOf('X'), Items.aC });
		this.a(new ItemStack(Items.bb, 1), new Object[] { "#X#", "III", Character.valueOf('#'), Blocks.REDSTONE_TORCH, Character.valueOf('X'), Items.aC, Character.valueOf('I'), new ItemStack(Blocks.STONE, 1, bbb.a.a()) });
		this.a(new ItemStack(Items.ce, 1), new Object[] { " # ", "#X#", "III", Character.valueOf('#'), Blocks.REDSTONE_TORCH, Character.valueOf('X'), Items.cg, Character.valueOf('I'), new ItemStack(Blocks.STONE, 1, bbb.a.a()) });
		...
		this.a(new ItemStack(Blocks.HEAVY_WEIGHTED_PRESSURE_PLATE, 1), new Object[] { "##", Character.valueOf('#'), Items.j });
		this.a(new ItemStack(Blocks.LIGHT_WEIGHTED_PRESSURE_PLATE, 1), new Object[] { "##", Character.valueOf('#'), Items.k });
		...
		this.a(new ItemStack(Blocks.ENCHANTING_TABLE, 1), new Object[] { " B ", "D#D", "###", Character.valueOf('#'), Blocks.OBSIDIAN, Character.valueOf('B'), Items.aL, Character.valueOf('D'), Items.i });
		...
		this.a(new ItemStack(Blocks.DAYLIGHT_DETECTOR), new Object[] { "GGG", "QQQ", "WWW", Character.valueOf('G'), Blocks.GLASS, Character.valueOf('Q'), Items.cg, Character.valueOf('W'), Blocks.WOODEN_SLAB });
