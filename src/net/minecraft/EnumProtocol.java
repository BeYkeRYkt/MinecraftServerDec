	...
	PLAY(0) {
		{
			...
			registerPacket(PacketDirection.CLIENTBOUND, PacketOutListItem.class);
			registerPacket(PacketDirection.CLIENTBOUND, PacketOutPlayerAbilities.class);
			registerPacket(PacketDirection.CLIENTBOUND, PacketOutTabComplete.class);
			registerPacket(PacketDirection.CLIENTBOUND, PacketOutScoreboardObjective.class);
			registerPacket(PacketDirection.CLIENTBOUND, PacketOutUpdateScore.class);
			registerPacket(PacketDirection.CLIENTBOUND, PacketOutDisplayScoreboard.class);
			registerPacket(PacketDirection.CLIENTBOUND, PacketOutScoreboardTeam.class);
			registerPacket(PacketDirection.CLIENTBOUND, PacketOutPluginMessage.class);
			registerPacket(PacketDirection.CLIENTBOUND, PacketOutDisconnect.class);
			registerPacket(PacketDirection.CLIENTBOUND, PacketOutServerDifficulty.class);
			registerPacket(PacketDirection.CLIENTBOUND, PacketOutCombatEvent.class);
			registerPacket(PacketDirection.CLIENTBOUND, PacketOutCamera.class);
			registerPacket(PacketDirection.CLIENTBOUND, PacketOutWorldBorder.class);
