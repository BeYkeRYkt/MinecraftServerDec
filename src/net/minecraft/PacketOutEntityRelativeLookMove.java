...
public class PacketOutEntityRelativeLookMove extends PacketOutEntity {

	public PacketOutEntityRelativeLookMove() {
	}

	public PacketOutEntityRelativeLookMove(int entityId, byte diffX, byte diffY, byte diffZ, byte yaw, byte pitch, boolean onGround) {
		super(entityId);
		this.diffX = diffX;
		this.diffY = diffY;
		this.diffZ = diffZ;
