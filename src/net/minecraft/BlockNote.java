...
public class BlockNote extends atg {
	...
	public boolean interact(WorldServer var1, Position var2, IBlockState var3, EntityHuman var4, BlockFace var5, float var6, float var7, float var8) {
		if (var1.isStatic) {
			return true;
		} else {
	...
	public void a(WorldServer var1, Position var2, EntityHuman var3) {
		if (!var1.isStatic) {
	...
	public boolean a(WorldServer var1, Position var2, IBlockState var3, int var4, int var5) {
