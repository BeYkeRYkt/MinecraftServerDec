...
public class PacketPlayOutPlayerPositionAndLook implements Packet<PlayOutPacketListener> {
	...
	public PacketPlayOutPlayerPositionAndLook() {
	}

	public PacketPlayOutPlayerPositionAndLook(double x, double y, double z, float yaw, float pitch, Set<PositionFlag> flags) {
		this.x = x;
		this.y = y;
		this.z = z;
		this.yaw = yaw;
