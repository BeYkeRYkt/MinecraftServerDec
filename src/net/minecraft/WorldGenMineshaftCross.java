...
public class WorldGenMineshaftCross extends StructurePiece {
	...
	public WorldGenMineshaftCross(int var1, Random var2, CuboidArea var3, BlockFace var4) {
		super(var1);
		this.a = var4;
		this.l = var3;
		this.b = var3.d() > 3;
	...
	public void a(StructurePiece var1, List var2, Random var3) {
		...
		switch (bjf.a[this.a.ordinal()]) {
			case 1:
				WorldGenMineshaftPieces.a(var1, var2, var3, this.l.minX + 1, this.l.minY, this.l.minZ - 1, BlockFace.NORTH, var4);
				WorldGenMineshaftPieces.a(var1, var2, var3, this.l.minX - 1, this.l.minY, this.l.minZ + 1, BlockFace.WEST, var4);
				WorldGenMineshaftPieces.a(var1, var2, var3, this.l.maxX + 1, this.l.minY, this.l.minZ + 1, BlockFace.EAST, var4);
				break;
			case 2:
				WorldGenMineshaftPieces.a(var1, var2, var3, this.l.minX + 1, this.l.minY, this.l.maxZ + 1, BlockFace.SOUTH, var4);
				WorldGenMineshaftPieces.a(var1, var2, var3, this.l.minX - 1, this.l.minY, this.l.minZ + 1, BlockFace.WEST, var4);
				WorldGenMineshaftPieces.a(var1, var2, var3, this.l.maxX + 1, this.l.minY, this.l.minZ + 1, BlockFace.EAST, var4);
				break;
			case 3:
		...
		if (this.b) {
			if (var3.nextBoolean()) {
				WorldGenMineshaftPieces.a(var1, var2, var3, this.l.minX + 1, this.l.minY + 3 + 1, this.l.minZ - 1, BlockFace.NORTH, var4);
			}

			if (var3.nextBoolean()) {
				WorldGenMineshaftPieces.a(var1, var2, var3, this.l.minX - 1, this.l.minY + 3 + 1, this.l.minZ + 1, BlockFace.WEST, var4);
			}

			if (var3.nextBoolean()) {
				WorldGenMineshaftPieces.a(var1, var2, var3, this.l.maxX + 1, this.l.minY + 3 + 1, this.l.minZ + 1, BlockFace.EAST, var4);
			}

			if (var3.nextBoolean()) {
				WorldGenMineshaftPieces.a(var1, var2, var3, this.l.minX + 1, this.l.minY + 3 + 1, this.l.maxZ + 1, BlockFace.SOUTH, var4);
			}
		}
