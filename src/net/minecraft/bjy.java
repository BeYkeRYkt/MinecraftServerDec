...
public class bjy extends bkb {
	...
	public bjy(int var1, Random var2, bjb var3, PaintingDirection var4) {
		super(var1);
		this.m = var4;
		this.l = var3;
	...
	public static bjy a(List var0, Random var1, int var2, int var3, int var4, PaintingDirection var5, int var6) {
	...
	public boolean a(World var1, Random var2, bjb var3) {
		...
		this.a(var1, var3, 1, 3, 4, 1, 4, 4, Blocks.NETHER_BRICK_FENCE.P(), Blocks.NETHER_BRICK.P(), false);
		this.a(var1, var3, 3, 3, 4, 3, 4, 4, Blocks.NETHER_BRICK_FENCE.P(), Blocks.NETHER_BRICK.P(), false);
