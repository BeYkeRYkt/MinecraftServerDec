...
public class PacketPlayOutCombatEvent implements Packet<PlayOutPacketListener> {
	...
	public PacketPlayOutCombatEvent(CombatTracker tracker, CombatEvent combatEvent) {
		...
		switch (combatEvent) {
			...
			case END_COMBAT: { 
				...
				this.entityId = entity == null ? -1 : entity.getId();
				this.message = tracker.getMessage().getJsonMessage();
			}
			default: {
				break;
			}
