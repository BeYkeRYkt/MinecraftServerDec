...
public class PacketOutJoinGame implements Packet<PlayClientboundPacketListener> {
	...
	public PacketOutJoinGame(int entityId, GameMode playerGameMode, boolean isHardcore, int dimensionId, Difficulty difficulty, int maxPlayers, LevelType levelType, boolean debugInfo) {
