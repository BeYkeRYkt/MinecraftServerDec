...
public interface IWorldAccess {
	...
	void a(String var1, Position var2);

	void a(int var1, Position var2, int var3);

	void a(EntityHuman var1, int var2, Position var3, int var4);

	void b(int var1, Position var2, int var3);
}
