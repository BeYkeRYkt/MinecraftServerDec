...
public class blr {
	...
	private static bmk a(Class var0, List var1, Random var2, int var3, int var4, int var5, BlockFace var6, int var7) {
		Object var8 = null;
		if (var0 == bmi.class) {
	...
	private static bmk b(bmh var0, List var1, Random var2, int var3, int var4, int var5, BlockFace var6, int var7) {
		if (!d()) {
			return null;
		} else {
			if (d != null) {
			...
			CuboidArea var14 = blw.a(var1, var2, var3, var4, var5, var6);
	...
	private static bms c(bmh var0, List var1, Random var2, int var3, int var4, int var5, BlockFace var6, int var7) {
		if (var7 > 50) {
			return null;
	...
	// $FF: synthetic method
	static bms a(bmh var0, List var1, Random var2, int var3, int var4, int var5, BlockFace var6, int var7) {
