...
public class PacketOutTimeUpdate implements Packet<PlayClientboundPacketListener> {
	...
	public PacketOutTimeUpdate(long worldAge, long time, boolean doDayLightCycle) {
