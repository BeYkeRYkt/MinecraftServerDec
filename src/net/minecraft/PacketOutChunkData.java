...
public class PacketOutChunkData implements Packet<PlayClientboundPacketListener> {
	...
	public PacketOutChunkData(Chunk chunk, boolean allSections, int inputBitMap) {
		this.chunkX = chunk.x;
		this.chunkY = chunk.y;
