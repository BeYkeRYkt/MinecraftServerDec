...
public class PacketJoinGame implements Packet<PlayPacketListener> {
	...
	public PacketJoinGame(int entityId, GameMode playerGameMode, boolean isHardcore, int dimensionId, Difficulty difficulty, int maxPlayers, LevelType levelType, boolean debugInfo) {
