...
public class bjh extends bms {
	...
	protected void b(NBTCompoundTag var1) {
		...
		this.a = PaintingDirection.fromByte(var1.getInt("D"));
	}

	public bjh(int var1, Random var2, bjb var3, PaintingDirection var4) {
		super(var1);
		this.a = var4;
		this.l = var3;
		this.b = var3.d() > 3;
	...
	public void a(bms var1, List var2, Random var3) {
		...
		switch (bjf.a[this.a.ordinal()]) {
			case 1:
				bje.a(var1, var2, var3, this.l.a + 1, this.l.b, this.l.c - 1, PaintingDirection.c, var4);
				bje.a(var1, var2, var3, this.l.a - 1, this.l.b, this.l.c + 1, PaintingDirection.e, var4);
				bje.a(var1, var2, var3, this.l.d + 1, this.l.b, this.l.c + 1, PaintingDirection.f, var4);
				break;
			case 2:
				bje.a(var1, var2, var3, this.l.a + 1, this.l.b, this.l.f + 1, PaintingDirection.d, var4);
				bje.a(var1, var2, var3, this.l.a - 1, this.l.b, this.l.c + 1, PaintingDirection.e, var4);
				bje.a(var1, var2, var3, this.l.d + 1, this.l.b, this.l.c + 1, PaintingDirection.f, var4);
				break;
			case 3:
		...
		if (this.b) {
			if (var3.nextBoolean()) {
				bje.a(var1, var2, var3, this.l.a + 1, this.l.b + 3 + 1, this.l.c - 1, PaintingDirection.c, var4);
			}

			if (var3.nextBoolean()) {
				bje.a(var1, var2, var3, this.l.a - 1, this.l.b + 3 + 1, this.l.c + 1, PaintingDirection.e, var4);
			}

			if (var3.nextBoolean()) {
				bje.a(var1, var2, var3, this.l.d + 1, this.l.b + 3 + 1, this.l.c + 1, PaintingDirection.f, var4);
			}

			if (var3.nextBoolean()) {
				bje.a(var1, var2, var3, this.l.a + 1, this.l.b + 3 + 1, this.l.f + 1, PaintingDirection.d, var4);
			}
		}
