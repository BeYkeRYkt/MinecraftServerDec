...
public class aaq extends aaw {
	...
	public aaq(final EntityCreature var1, Class var2, int var3, boolean var4, boolean var5, Predicate var6) {
	...
	public boolean a() {
		if (this.g > 0 && this.e.bb().nextInt(this.g) != 0) {
			...
			double var1 = this.f();
			List var3 = this.e.world.a(this.a, this.e.getBoundingBox().grow(var1, 4.0D, var1), Predicates.and(this.c, EntityPredicates.d));
