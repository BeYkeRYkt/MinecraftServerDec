...
public class WorldGenNetherPiece12 extends WorldGenNetherPiece {
	...
	public WorldGenNetherPiece12(int var1, Random var2, CuboidArea var3, BlockFace var4) {
		super(var1);
		this.m = var4;
		this.l = var3;
	}
	...
	public static WorldGenNetherPiece12 a(List var0, Random var1, int var2, int var3, int var4, int var5, BlockFace var6) {
		CuboidArea var7 = CuboidArea.a(var2, var3, var4, -2, 0, 0, 7, 8, 9, var6);
		return a(var7) && StructurePiece.a(var0, var7) == null ? new WorldGenNetherPiece12(var5, var1, var7, var6) : null;
	}
		...
		if (!this.b) {
			...
			if (var3.b((fd) var4)) {
				...
				if (var5 instanceof TileEntityMobSpawner) {
					((TileEntityMobSpawner) var5).getSpawner().setMobName("Blaze");
				}
			}
		}
