...
public class EntityLightning extends EntityWeather {
	...
	public EntityLightning(World var1, double var2, double var4, double var6) {
		...
		if (!var1.isStatic && var1.Q().b("doFireTick") && (var1.getDifficulty() == Difficulty.NORMAL || var1.getDifficulty() == Difficulty.HARD) && var1.a(new Position(this), (int) 10)) {
	...
	public void s_() {
		...
		if (this.b < 0) {
			if (this.c == 0) {
				...
				if (!this.world.isStatic && this.world.Q().b("doFireTick") && this.world.a(var1, (int) 10) && this.world.getBlockState(var1).getBlock().getMaterial() == Material.AIR && Blocks.FIRE.c(this.world, var1)) {
