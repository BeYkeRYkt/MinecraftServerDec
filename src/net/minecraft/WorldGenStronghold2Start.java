...
public class WorldGenStronghold2Start extends StructureStart {
	...
	public WorldGenStronghold2Start(World var1, Random var2, int var3, int var4) {
		super(var3, var4);
		WorldGenStrongholdPieces.b();
		WorldGenStrongholdStart var5 = new WorldGenStrongholdStart(0, var2, (var3 << 4) + 2, (var4 << 4) + 2);
		this.a.add(var5);
