...
public class EntityVillager extends ws implements ago, aqb {
	...
	private static final agw[][][][] bA = new agw[][][][] {
			{
					{ { new agr(Items.O, new agx(18, 22)), new agr(Items.bS, new agx(15, 19)), new agr(Items.bR, new agx(15, 19)), new agv(Items.P, new agx(-4, -2)) }, { new agr(Item.getItemOf(Blocks.aU), new agx(8, 13)), new agv(Items.ca, new agx(-3, -2)) }, { new agr(Item.getItemOf(Blocks.bk), new agx(7, 12)), new agv(Items.e, new agx(-5, -7)) }, { new agv(Items.bc, new agx(-6, -10)), new agv(Items.aZ, new agx(1, 1)) } },
			...
			{ { { new agr(Items.bt, new agx(36, 40)), new agr(Items.k, new agx(8, 10)) }, { new agv(Items.aC, new agx(-4, -1)), new agv(new ItemStack(Items.aW, 1, akv.l.b()), new agx(-2, -1)) }, { new agv(Items.bH, new agx(7, 11)), new agv(Item.getItemOf(Blocks.aX), new agx(-3, -1)) }, { new agv(Items.bK, new agx(3, 11)) } } },
