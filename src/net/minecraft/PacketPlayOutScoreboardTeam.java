...
public class PacketPlayOutScoreboardTeam implements Packet<PlayOutPacketListener> {
	...
	public PacketPlayOutScoreboardTeam(ScoreboardTeam team, Collection<String> players, int mode) {
		this.visibility = ScoreboardTeamNameTagVisibility.ALWAYS.name;
		this.color = -1;
		this.players = Lists.newArrayList();
		if (mode != 3 && mode != 4) {
