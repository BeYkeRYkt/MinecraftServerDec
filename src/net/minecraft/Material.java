...
public class Material {
	...
	public static final Material HEAVY = (new Material(MaterialMapColor.h)).f().setBlockPushReaction();
	...
	public static final Material PACKED_ICE = (new MaterialDecoration(MaterialMapColor.j)).i().s().f().setBreakPushReaction();
	...
	public static final Material WEB = (new MaterialWeb(MaterialMapColor.e)).f().setBreakPushReaction();
	public static final Material PISTON = (new Material(MaterialMapColor.m)).setBlockPushReaction();
	public static final Material BARRIER = (new Material(MaterialMapColor.b)).f().setBlockPushReaction();
