...
public class PacketPlayOutSoundEffect implements Packet<PlayOutPacketListener> {
	...
	public PacketPlayOutSoundEffect(String soundName, double x, double y, double z, float volume, float pitch) {
