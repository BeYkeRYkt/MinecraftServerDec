...
public class CommandBlockStatistic {
	...
	public CommandBlockStatistic() {
		this.c = b;
		this.d = b;
	}

	public void a(CommandSenderInterface var1, ag var2, int var3) {
		String var4 = this.c[var2.a()];
		if (var4 != null) {
			String var5;
			try {
				var5 = AbstractCommand.e(var1, var4);
			} catch (dj var10) {
				return;
			}
			...
			if (var6 != null) {
				...
				if (var8 != null) {
					if (var7.b(var5, var8)) {
						ScoreboardScore var9 = var7.c(var5, var8);
						var9.setScore(var3);
					}
				}
			}
	...
	public static void a(CommandBlockStatistic var0, ag var1, String var2, String var3) {
	...
	private static void a(CommandBlockStatistic var0, ag var1) {
		if (var0.c != b && var0.d != b) {
			var0.c[var1.a()] = null;
			var0.d[var1.a()] = null;
			boolean var2 = true;
	...
	public void a(CommandBlockStatistic var1) {
		ag[] var2 = ag.values();
