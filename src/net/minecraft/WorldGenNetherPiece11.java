...
public class WorldGenNetherPiece11 extends WorldGenNetherPiece {
	...
	public WorldGenNetherPiece11(int var1, Random var2, CuboidArea var3, BlockFace var4) {
		super(var1);
		this.m = var4;
		this.l = var3;
	}
	...
	public void a(StructurePiece var1, List var2, Random var3) {
		...
		this.a((WorldGenNetherPiece15) var1, var2, var3, 5, 11, true);
	}

	public static WorldGenNetherPiece11 a(List var0, Random var1, int var2, int var3, int var4, BlockFace var5, int var6) {
		CuboidArea var7 = CuboidArea.a(var2, var3, var4, -5, -3, 0, 13, 14, 13, var5);
		return a(var7) && StructurePiece.a(var0, var7) == null ? new WorldGenNetherPiece11(var6, var1, var7, var5) : null;
	}
	...
	public boolean a(World var1, Random var2, CuboidArea var3) {
		...
		for (var5 = 0; var5 <= 6; ++var5) {
			...
			if (var6 >= 5 && var6 <= 8) {
				this.a(var1, var3, 5, 5, var6, 7, var5 + 4, var6, Blocks.NETHER_BRICK.getBlockState(), Blocks.NETHER_BRICK.getBlockState(), false);
			} else if (var6 >= 9 && var6 <= 10) {
				this.a(var1, var3, 5, 8, var6, 7, var5 + 4, var6, Blocks.NETHER_BRICK.getBlockState(), Blocks.NETHER_BRICK.getBlockState(), false);
			}

			if (var5 >= 1) {
				this.a(var1, var3, 5, 6 + var5, var6, 7, 9 + var5, var6, Blocks.AIR.getBlockState(), Blocks.AIR.getBlockState(), false);
			}
		}
		...
		this.a(var1, var3, 7, 6, 7, 7, 7, 7, Blocks.NETHER_BRICK_FENCE.getBlockState(), Blocks.NETHER_BRICK_FENCE.getBlockState(), false);
		this.a(var1, var3, 5, 13, 12, 7, 13, 12, Blocks.AIR.getBlockState(), Blocks.AIR.getBlockState(), false);
		this.a(var1, var3, 2, 5, 2, 3, 5, 3, Blocks.NETHER_BRICK.getBlockState(), Blocks.NETHER_BRICK.getBlockState(), false);
		this.a(var1, var3, 2, 5, 9, 3, 5, 10, Blocks.NETHER_BRICK.getBlockState(), Blocks.NETHER_BRICK.getBlockState(), false);
		this.a(var1, var3, 2, 5, 4, 2, 5, 8, Blocks.NETHER_BRICK.getBlockState(), Blocks.NETHER_BRICK.getBlockState(), false);
		this.a(var1, var3, 9, 5, 2, 10, 5, 3, Blocks.NETHER_BRICK.getBlockState(), Blocks.NETHER_BRICK.getBlockState(), false);
		this.a(var1, var3, 9, 5, 9, 10, 5, 10, Blocks.NETHER_BRICK.getBlockState(), Blocks.NETHER_BRICK.getBlockState(), false);
		...
		this.a(var1, var3, 8, 5, 4, 9, 5, 8, Blocks.NETHER_WART.getBlockState(), Blocks.NETHER_WART.getBlockState(), false);
		...
		for (var7 = 4; var7 <= 8; ++var7) {
			for (var8 = 0; var8 <= 2; ++var8) {
				this.b(var1, Blocks.NETHER_BRICK.getBlockState(), var7, -1, var8, var3);
				this.b(var1, Blocks.NETHER_BRICK.getBlockState(), var7, -1, 12 - var8, var3);
			}
		}
		...
		for (var7 = 0; var7 <= 2; ++var7) {
			for (var8 = 4; var8 <= 8; ++var8) {
				this.b(var1, Blocks.NETHER_BRICK.getBlockState(), var7, -1, var8, var3);
				this.b(var1, Blocks.NETHER_BRICK.getBlockState(), 12 - var7, -1, var8, var3);
			}
		}
