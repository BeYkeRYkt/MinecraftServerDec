...
public class PacketOutSpawnExpirienceOrb implements Packet<PlayClientboundPacketListener> {
	...
	public PacketOutSpawnExpirienceOrb() {
	}

	public PacketOutSpawnExpirienceOrb(EntityExpirienceOrb orb) {
