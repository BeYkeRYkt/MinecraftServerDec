...
public class WorldGenStrongholdPortalRoom extends WorldGenStrongholdPiece {
	...
	public WorldGenStrongholdPortalRoom(int var1, Random var2, CuboidArea var3, BlockFace var4) {
		super(var1);
		this.m = var4;
		this.l = var3;
	}
	...
	public void a(StructurePiece var1, List var2, Random var3) {
		if (var1 != null) {
			((WorldGenStrongholdStart) var1).b = this;
		}

	}

	public static WorldGenStrongholdPortalRoom a(List var0, Random var1, int var2, int var3, int var4, BlockFace var5, int var6) {
		CuboidArea var7 = CuboidArea.a(var2, var3, var4, -4, -1, 0, 11, 8, 16, var5);
		return a(var7) && StructurePiece.a(var0, var7) == null ? new WorldGenStrongholdPortalRoom(var6, var1, var7, var5) : null;
	}

	public boolean a(World var1, Random var2, CuboidArea var3) {
		this.a(var1, var3, 0, 0, 0, 10, 7, 15, false, var2, WorldGenStrongholdPieces.c());
		this.a(var1, var2, var3, bml.c, 4, 1, 0);
		byte var4 = 6;
		this.a(var1, var3, 1, var4, 1, 1, var4, 14, false, var2, WorldGenStrongholdPieces.c());
		this.a(var1, var3, 9, var4, 1, 9, var4, 14, false, var2, WorldGenStrongholdPieces.c());
		this.a(var1, var3, 2, var4, 1, 8, var4, 2, false, var2, WorldGenStrongholdPieces.c());
		this.a(var1, var3, 2, var4, 14, 8, var4, 14, false, var2, WorldGenStrongholdPieces.c());
		this.a(var1, var3, 1, 1, 1, 2, 1, 4, false, var2, WorldGenStrongholdPieces.c());
		this.a(var1, var3, 8, 1, 1, 9, 1, 4, false, var2, WorldGenStrongholdPieces.c());
		...
		this.a(var1, var3, 3, 1, 8, 7, 1, 12, false, var2, WorldGenStrongholdPieces.c());
		...
		this.a(var1, var3, 4, 1, 5, 6, 1, 7, false, var2, WorldGenStrongholdPieces.c());
		this.a(var1, var3, 4, 2, 6, 6, 2, 7, false, var2, WorldGenStrongholdPieces.c());
		this.a(var1, var3, 4, 3, 7, 6, 3, 7, false, var2, WorldGenStrongholdPieces.c());
