...
public class PacketHandshakingInSetProtocol implements Packet<HandshakingServerboundPacketListener> {
	...
	public void handlePacket(HandshakingServerboundPacketListener listener) {
