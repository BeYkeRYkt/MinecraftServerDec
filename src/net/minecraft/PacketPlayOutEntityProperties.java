...
public class PacketPlayOutEntityProperties implements Packet<PlayOutPacketListener> {
	...
	public PacketPlayOutEntityProperties(int entityId, Collection<AttributeInstance> attributes) {
