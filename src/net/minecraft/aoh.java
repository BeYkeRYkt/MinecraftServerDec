...
public class aoh {
	...
	public void a(aop var1) {
		...
		var1.b(new ItemStack(Items.aW, 1, akv.o.b()), new Object[] { new ItemStack(Blocks.RED_FLOWER, 1, awa.b.b()) });
		...
		var1.b(new ItemStack(Items.aW, 1, akv.d.b()), new Object[] { new ItemStack(Blocks.RED_FLOWER, 1, awa.c.b()) });
		var1.b(new ItemStack(Items.aW, 1, akv.c.b()), new Object[] { new ItemStack(Blocks.RED_FLOWER, 1, awa.d.b()) });
		var1.b(new ItemStack(Items.aW, 1, akv.i.b()), new Object[] { new ItemStack(Blocks.RED_FLOWER, 1, awa.e.b()) });
		var1.b(new ItemStack(Items.aW, 1, akv.o.b()), new Object[] { new ItemStack(Blocks.RED_FLOWER, 1, awa.f.b()) });
		var1.b(new ItemStack(Items.aW, 1, akv.b.b()), new Object[] { new ItemStack(Blocks.RED_FLOWER, 1, awa.g.b()) });
