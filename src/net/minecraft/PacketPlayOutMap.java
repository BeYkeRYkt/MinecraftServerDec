...
public class PacketPlayOutMap implements Packet<PlayOutPacketListener> {
	...
	public PacketPlayOutMap(int itemDamage, byte scale, Collection<MapIcon> icons, byte[] data, int columns, int rows, int x, int y) {
