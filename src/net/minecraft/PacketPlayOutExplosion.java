...
public class PacketPlayOutExplosion implements Packet<PlayOutPacketListener> {
	...
	public PacketPlayOutExplosion(double x, double y, double z, float radius, List<Position> positions, Vec3D vec) {
		this.x = x;
		this.y = y;
		this.z = z;
		this.radius = radius;
