...
public class PacketPlayOutParticle implements Packet<PlayOutPacketListener> {
	...
	public PacketPlayOutParticle() {
	}

	public PacketPlayOutParticle(Particle particle, boolean longDistance, float x, float y, float z, float offX, float offY, float offZ, float particleData, int count, int... data) {
