...
public class amu extends aks {
	...
	private static final Set c = Sets.newHashSet((Object[]) (new atr[] { aty.cs, aty.q, aty.e, aty.E, aty.ah, aty.ag, aty.T, aty.D, aty.R, aty.o, aty.aI, aty.S, aty.p, aty.y, aty.x, aty.aD, aty.Y, aty.aV, aty.cB, aty.av, aty.aC, aty.A, aty.cM, aty.b, aty.U }));
