...
public class bji extends bms {
	...
	public void a(bms var1, List var2, Random var3) {
		...
		for (var5 = 0; var5 < this.l.c(); var5 += 4) {
			...
			var7 = bje.a(var1, var2, var3, this.l.a + var5, this.l.b + var3.nextInt(var6) + 1, this.l.c - 1, BlockFace.c, var4);
			if (var7 != null) {
				var8 = var7.c();
		...
		for (var5 = 0; var5 < this.l.c(); var5 += 4) {
			...
			var7 = bje.a(var1, var2, var3, this.l.a + var5, this.l.b + var3.nextInt(var6) + 1, this.l.f + 1, BlockFace.d, var4);
			if (var7 != null) {
				var8 = var7.c();
		...
		for (var5 = 0; var5 < this.l.e(); var5 += 4) {
			...
			var7 = bje.a(var1, var2, var3, this.l.a - 1, this.l.b + var3.nextInt(var6) + 1, this.l.c + var5, BlockFace.e, var4);
			if (var7 != null) {
				var8 = var7.c();
		...
		for (var5 = 0; var5 < this.l.e(); var5 += 4) {
			...
			var7 = bje.a(var1, var2, var3, this.l.d + 1, this.l.b + var3.nextInt(var6) + 1, this.l.c + var5, BlockFace.f, var4);
			if (var7 != null) {
				var8 = var7.c();
