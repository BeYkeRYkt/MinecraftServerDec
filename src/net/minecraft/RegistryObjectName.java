...
public class RegistryObjectName {

	protected final String modname;
	protected final String blockname;

	protected RegistryObjectName(int i, String... blockInfo) {
	...
	public RegistryObjectName(String blockName) {
	...
	public boolean equals(Object var1) {
		if (this == var1) {
			return true;
		} else if (!(var1 instanceof RegistryObjectName)) {
			return false;
		} else {
			RegistryObjectName var2 = (RegistryObjectName) var1;
