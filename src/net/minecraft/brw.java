...
public class brw {
	...
	public brw a() {
		double var1 = (double) DataTypesConverter.a(this.a * this.a + this.b * this.b + this.c * this.c);
	...
	public double b() {
		return (double) DataTypesConverter.a(this.a * this.a + this.b * this.b + this.c * this.c);
	}
