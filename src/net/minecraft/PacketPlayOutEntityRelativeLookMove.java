...
public class PacketPlayOutEntityRelativeLookMove extends PacketPlayOutEntity {

	public PacketPlayOutEntityRelativeLookMove() {
	}

	public PacketPlayOutEntityRelativeLookMove(int entityId, byte diffX, byte diffY, byte diffZ, byte yaw, byte pitch, boolean onGround) {
		super(entityId);
		this.diffX = diffX;
		this.diffY = diffY;
		this.diffZ = diffZ;
