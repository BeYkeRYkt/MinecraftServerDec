...
public class PacketOutSpawnObject implements Packet<PlayClientboundPacketListener> {
	...
	public PacketOutSpawnObject(Entity entity, int type) {
		this(entity, type, 0);
	}

	public PacketOutSpawnObject(Entity entity, int type, int contentsLength) {
